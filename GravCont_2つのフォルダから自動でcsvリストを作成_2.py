...
grav_dir = "/Users/kitaguchi/Desktop/Grav_bootcamp/Pretrain/grav"
cont_dir = "/Users/kitaguchi/Desktop/Grav_bootcamp/Pretrain/cont"
grav = os.listdir(grav_dir)
cont = os.listdir(cont_dir)
print("grav: "+str(len(grav)))
print("cont: "+str(len(cont)))

columns1 = ["image_name", "Label", "Nakagawa"]
...
# CSVとして出力
df.to_csv("/Users/kitaguchi/Desktop/Grav_bootcamp/Pratrain_eval.csv",
          encoding="shift_jis")
